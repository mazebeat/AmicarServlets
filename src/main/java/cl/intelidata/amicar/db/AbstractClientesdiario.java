...
/**
 * AbstractClientesdiario entity provides the base persistence definition of the Clientesdiario entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
