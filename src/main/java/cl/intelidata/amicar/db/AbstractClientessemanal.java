...
/**
 * AbstractClientessemanal entity provides the base persistence definition of the Clientessemanal entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
