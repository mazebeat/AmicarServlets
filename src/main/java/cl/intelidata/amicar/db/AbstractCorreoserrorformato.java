...
/**
 * AbstractCorreoserrorformato entity provides the base persistence definition of the Correoserrorformato entity. @author MyEclipse Persistence Tools
 */
@MappedSuperclass
